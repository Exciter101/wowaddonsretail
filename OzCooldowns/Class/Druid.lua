...
if OzCooldowns.MyClass ~= 'DRUID' then
	return
end

OzCooldowns.SpellList = {
	...
	102383,	-- Wild Charge (Boomkin Form)
	102401,	-- Wild Charge (Human Form)
